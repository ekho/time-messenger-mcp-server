...
| Инструмент | Описание |
|---|---|
| `add_reaction` | Поставить эмодзи-реакцию на сообщение |
| `remove_reaction` | Убрать свою реакцию с сообщения |
| `get_reactions` | Список реакций на сообщении |

`emoji_name` принимает имя эмодзи (`thumbsup`), запись с двоеточиями (`:tada:`)
или сам символ для распространённых эмодзи (`👍`).
